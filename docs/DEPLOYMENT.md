...
2. Copy:
   ...
   - **anon public key** (e.g., `sb_publishable_xxxxxxxxxxxxx`)
...
2. Add the following variables:
   ...
   | `SUPABASE_DB_URL` | `postgresql://postgres:[YOUR_DATABASE_PASSWORD]@db.[YOUR_PROJECT_REF].supabase.co:5432/postgres` | For migrations |
